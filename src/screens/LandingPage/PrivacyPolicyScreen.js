    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="Interpretation and Definitions">
          ...
          <p className="Text__header">Interpretation and Definitions</p>
          <p className="Text__subheader">Interpretation</p>
          <p>
          ...
          <p className="Text__subheader">Definitions</p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to MeetBalls.
              </p>
            </li>
            <li>
              <p>
          ...
          <p className="Text__subheader">Types of Data Collected</p>
          <p className="Text__subsubheader">Personal Data</p>
          <p>
          ...
          <p className="Text__subsubheader">Usage Data</p>
          ...
          <p className="Text__subheader">Use of Your Personal Data</p>
          ...
          <p className="Text__subheader">Retention of Your Personal Data</p>
          <p>
          ...
          <p className="Text__subheader">Transfer of Your Personal Data</p>
          <p>
          ...
          <p className="Text__subheader">Disclosure of Your Personal Data</p>
          <p className="Text__subsubheader">Business Transactions</p>
          <p>
          ...
          <p className="Text__subsubheader">Law enforcement</p>
          <p>
          ...
          <p className="Text__subsubheader">Other legal requirements</p>
          <p>
          ...
          <p className="Text__subheader">Security of Your Personal Data</p>
          <p>
          ...
          <p className="Text__header">Children's Privacy</p>
          <p>
          ...
          <p className="Text__header">Links to Other Websites</p>
          <p>
          ...
          <p className="Text__header">Changes to this Privacy Policy</p>
          <p>
          ...
          <p className="Text__header">Contact Us</p>
          <p>
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <ul>
            <li>By email: zoommeetballs@gmail.com</li>
          </ul>
        </Col>
      </Row>
      <AppFooter />
